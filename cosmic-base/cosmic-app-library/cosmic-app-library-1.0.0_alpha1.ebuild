...
declare -A GIT_CRATES=(
	...
	[cosmic-app-list-config]='https://github.com/pop-os/cosmic-applets;478bb3e500ab1d9e7cbaa1d4d7695d137fbeac8c;cosmic-applets-%commit%/cosmic-app-list/cosmic-app-list-config'
...
SRC_URI="
	https://github.com/pop-os/cosmic-applibrary/archive/${COMMIT}/${P}.tar.gz
	${CARGO_CRATE_URIS}
"
S="${WORKDIR}/cosmic-applibrary-${COMMIT}"
