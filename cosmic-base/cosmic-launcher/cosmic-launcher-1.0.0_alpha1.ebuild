...
declare -A GIT_CRATES=(
	...
	[cosmic-config-derive]='https://github.com/pop-os/libcosmic;22138671b4af21b58a4273a5aa2f7b4c3247c393;libcosmic-%commit%/cosmic-config-derive'
	[cosmic-config]='https://github.com/pop-os/libcosmic;22138671b4af21b58a4273a5aa2f7b4c3247c393;libcosmic-%commit%/cosmic-config'
	...
	[cosmic-theme]='https://github.com/pop-os/libcosmic;22138671b4af21b58a4273a5aa2f7b4c3247c393;libcosmic-%commit%/cosmic-theme'
	...
	[libcosmic]='https://github.com/pop-os/libcosmic;22138671b4af21b58a4273a5aa2f7b4c3247c393;libcosmic-%commit%'
	...
	[pop-launcher-service]='https://github.com/pop-os/launcher;091581c3620a4cf3979e70f68c4af23654104bec;launcher-%commit%/service'
	[pop-launcher]='https://github.com/pop-os/launcher;091581c3620a4cf3979e70f68c4af23654104bec;launcher-%commit%'
...
SRC_URI="
	https://github.com/pop-os/cosmic-launcher/archive/${COMMIT}/${P}.tar.gz
	${CARGO_CRATE_URIS}
"
S="${WORKDIR}/${PN}-${COMMIT}"
...
QA_FLAGS_IGNORED="usr/bin/cosmic-launcher"

src_prepare() {
	default

	# libcosmic iced deps
	rmdir "${WORKDIR}/libcosmic-22138671b4af21b58a4273a5aa2f7b4c3247c393/iced" || die
	ln -s "${WORKDIR}/iced-fa817c704dd815cc5723470c49459ad8f81c78f8" \
		"${WORKDIR}/libcosmic-22138671b4af21b58a4273a5aa2f7b4c3247c393/iced" || die
}
