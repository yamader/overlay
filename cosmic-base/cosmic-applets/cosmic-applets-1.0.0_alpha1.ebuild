...
declare -A GIT_CRATES=(
	...
	[cosmic-comp-config]='https://github.com/pop-os/cosmic-comp;5eb5af46756f2f2bc5e812cf68fe4c4b79efd924;cosmic-comp-%commit%/cosmic-comp-config'
	[cosmic-config-derive]='https://github.com/pop-os/libcosmic;4f77edd249e1c9cd525232050cec00c752ce7860;libcosmic-%commit%/cosmic-config-derive'
	[cosmic-config]='https://github.com/pop-os/libcosmic;4f77edd249e1c9cd525232050cec00c752ce7860;libcosmic-%commit%/cosmic-config'
	[cosmic-dbus-networkmanager]='https://github.com/pop-os/dbus-settings-bindings;cd21ddcb1b5cbfc80ab84b34d3c8b1ff3d81179a;dbus-settings-bindings-%commit%/networkmanager'
	[cosmic-notifications-config]='https://github.com/pop-os/cosmic-notifications;2caf2fb640e3601fac4dee1ae5c0121f75adcb51;cosmic-notifications-%commit%/cosmic-notifications-config'
	[cosmic-notifications-util]='https://github.com/pop-os/cosmic-notifications;2caf2fb640e3601fac4dee1ae5c0121f75adcb51;cosmic-notifications-%commit%/cosmic-notifications-util'
	[cosmic-panel-config]='https://github.com/pop-os/cosmic-panel;d5fc4ddef106bf2bdaf983028f78b9d8e432b3ae;cosmic-panel-%commit%/cosmic-panel-config'
	...
	[cosmic-settings-subscriptions]='https://github.com/pop-os/cosmic-settings-subscriptions;c19240ad2c9f11ef5cec8ed8c70255c3dc9ae8d4;cosmic-settings-subscriptions-%commit%'
	[cosmic-text]='https://github.com/pop-os/cosmic-text;58c2ccd1fb3daf0abc792f9dd52b5766b7125ccd;cosmic-text-%commit%'
	[cosmic-theme]='https://github.com/pop-os/libcosmic;4f77edd249e1c9cd525232050cec00c752ce7860;libcosmic-%commit%/cosmic-theme'
	[cosmic-time]='https://github.com/pop-os/cosmic-time;dd973b3ced4b6cf784c78a1c36f1526dfbfbfa19;cosmic-time-%commit%'
	...
	[iced_futures]='https://github.com/pop-os/libcosmic;4f77edd249e1c9cd525232050cec00c752ce7860;libcosmic-%commit%/iced/futures'
	...
	[libcosmic]='https://github.com/pop-os/libcosmic;4f77edd249e1c9cd525232050cec00c752ce7860;libcosmic-%commit%'
	[mime]='https://github.com/pop-os/window_clipboard;7c59b07b9172d8e0401f7e06609e1050575309c9;window_clipboard-%commit%/mime'
	[mpris2-zbus]='https://github.com/pop-os/dbus-settings-bindings;cd21ddcb1b5cbfc80ab84b34d3c8b1ff3d81179a;dbus-settings-bindings-%commit%/mpris2'
	...
	[switcheroo-control]='https://github.com/pop-os/dbus-settings-bindings;cd21ddcb1b5cbfc80ab84b34d3c8b1ff3d81179a;dbus-settings-bindings-%commit%/switcheroo-control'
	...
	[xdg-shell-wrapper-config]='https://github.com/pop-os/cosmic-panel;d5fc4ddef106bf2bdaf983028f78b9d8e432b3ae;cosmic-panel-%commit%/xdg-shell-wrapper-config'
)
...
SRC_URI="
	https://github.com/pop-os/cosmic-applets/archive/${COMMIT}/${P}.tar.gz
	${CARGO_CRATE_URIS}
"
S="${WORKDIR}/${PN}-${COMMIT}"
...
src_prepare() {
	...
	# libcosmic iced deps
	rmdir "${WORKDIR}/libcosmic-4f77edd249e1c9cd525232050cec00c752ce7860/iced" || die
	ln -s "${WORKDIR}/iced-fa817c704dd815cc5723470c49459ad8f81c78f8" \
		"${WORKDIR}/libcosmic-4f77edd249e1c9cd525232050cec00c752ce7860/iced" || die
}
