...
declare -A GIT_CRATES=(
	...
	[cosmic-bg-config]='https://github.com/pop-os/cosmic-bg;f83d9f4c8e4b47bea3ef16e4894982919fef6b9a;cosmic-bg-%commit%/config'
	...
	[cosmic-config-derive]='https://github.com/pop-os/libcosmic;4da66f8cc0407b5c928b560fb36e75ba5bc5b2d9;libcosmic-%commit%/cosmic-config-derive'
	[cosmic-config]='https://github.com/pop-os/libcosmic;4da66f8cc0407b5c928b560fb36e75ba5bc5b2d9;libcosmic-%commit%/cosmic-config'
	[cosmic-files]='https://github.com/pop-os/cosmic-files;66cef478ba76b00efe19232d4dc528e609a2115f;cosmic-files-%commit%'
	...
	[cosmic-text]='https://github.com/pop-os/cosmic-text;a03ec6b75f0ea8fd6264d6cd05afcec3c2213f8f;cosmic-text-%commit%'
	[cosmic-theme]='https://github.com/pop-os/libcosmic;4da66f8cc0407b5c928b560fb36e75ba5bc5b2d9;libcosmic-%commit%/cosmic-theme'
	...
	[iced]='https://github.com/pop-os/iced;4c609e776a7721bddb6d50b60096f4d1f655491c;iced-%commit%'
	[iced_accessibility]='https://github.com/pop-os/iced;4c609e776a7721bddb6d50b60096f4d1f655491c;iced-%commit%/accessibility'
	[iced_core]='https://github.com/pop-os/iced;4c609e776a7721bddb6d50b60096f4d1f655491c;iced-%commit%/core'
	[iced_futures]='https://github.com/pop-os/iced;4c609e776a7721bddb6d50b60096f4d1f655491c;iced-%commit%/futures'
	[iced_graphics]='https://github.com/pop-os/iced;4c609e776a7721bddb6d50b60096f4d1f655491c;iced-%commit%/graphics'
	[iced_renderer]='https://github.com/pop-os/iced;4c609e776a7721bddb6d50b60096f4d1f655491c;iced-%commit%/renderer'
	[iced_runtime]='https://github.com/pop-os/iced;4c609e776a7721bddb6d50b60096f4d1f655491c;iced-%commit%/runtime'
	[iced_sctk]='https://github.com/pop-os/iced;4c609e776a7721bddb6d50b60096f4d1f655491c;iced-%commit%/sctk'
	[iced_style]='https://github.com/pop-os/iced;4c609e776a7721bddb6d50b60096f4d1f655491c;iced-%commit%/style'
	[iced_tiny_skia]='https://github.com/pop-os/iced;4c609e776a7721bddb6d50b60096f4d1f655491c;iced-%commit%/tiny_skia'
	[iced_wgpu]='https://github.com/pop-os/iced;4c609e776a7721bddb6d50b60096f4d1f655491c;iced-%commit%/wgpu'
	[iced_widget]='https://github.com/pop-os/iced;4c609e776a7721bddb6d50b60096f4d1f655491c;iced-%commit%/widget'
	[iced_winit]='https://github.com/pop-os/iced;4c609e776a7721bddb6d50b60096f4d1f655491c;iced-%commit%/winit'
	[libcosmic]='https://github.com/pop-os/libcosmic;4da66f8cc0407b5c928b560fb36e75ba5bc5b2d9;libcosmic-%commit%'
...
QA_FLAGS_IGNORED="usr/libexec/xdg-desktop-portal-cosmic"
...
src_prepare() {
	...
	cat >> "${ECARGO_HOME}/config.toml" <<- _EOF_ || die
		[patch.'https://gitlab.freedesktop.org/pipewire/pipewire-rs']
		pipewire-sys = { path = "${WORKDIR}/pipewire-rs-${COMMIT_PW}/pipewire-sys" }
		pipewire = { path = "${WORKDIR}/pipewire-rs-${COMMIT_PW}/pipewire" }
		libspa-sys = { path = "${WORKDIR}/pipewire-rs-${COMMIT_PW}/libspa-sys" }
		libspa = { path = "${WORKDIR}/pipewire-rs-${COMMIT_PW}/libspa" }
	_EOF_

	# libcosmic iced deps
	rmdir "${WORKDIR}/libcosmic-4da66f8cc0407b5c928b560fb36e75ba5bc5b2d9/iced" || die
	ln -s "${WORKDIR}/iced-4c609e776a7721bddb6d50b60096f4d1f655491c" \
		"${WORKDIR}/libcosmic-4da66f8cc0407b5c928b560fb36e75ba5bc5b2d9/iced" || die
}
...
src_configure() {
	...
	# for cosmic-files
	export VERGEN_GIT_COMMIT_DATE="2024-07-03"
	export VERGEN_GIT_SHA="66cef478ba76b00efe19232d4dc528e609a2115f"
}
