...
LICENSE="MIT"
SLOT="0"
IUSE="evdev experimental gps jack +libinput +logind mpd mpris network pipewire pulseaudio sndio systemd test tray +udev upower wifi"
REQUIRED_USE="
	upower? ( logind )
"
