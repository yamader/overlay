...
declare -A GIT_CRATES=(
	...
	[oxipng]='https://github.com/typst/oxipng;b8ec65b3ca42dde33c85149b6e402e891527f802;oxipng-%commit%'
	[self-replace]='https://github.com/typst/self-replace;2e6d5e4808bba73b713fd85cf5616b7d846143c2;self-replace-%commit%'
)
...
SRC_URI="
	https://github.com/typst/typst/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"
...
LICENSE+="
	Apache-2.0 Apache-2.0-with-LLVM-exceptions BSD-2 BSD CC0-1.0 CDDL
