...
RDEPEND=">=dev-haskell/aeson-1.4:=[profile?]
	...
	>=dev-haskell/cabal-plan-0.7.2:=[profile?] <dev-haskell/cabal-plan-0.8:=[profile?]
	...
	>=dev-haskell/streamly-0.8.2:=[profile?] <dev-haskell/streamly-0.9:=[profile?]
	...
	>=dev-haskell/yaml-streamly-0.12.0:=[profile?] <dev-haskell/yaml-streamly-0.13:=[profile?]
	>=dev-haskell/zlib-0.6.2.2:=[profile?] <dev-haskell/zlib-0.7:=[profile?]
	>=dev-lang/ghc-9.0.2:=
	>=dev-haskell/cabal-3.4.0.0:=[profile?] <dev-haskell/cabal-3.11:=[profile?]
	internal-downloader? ( >=dev-haskell/hsopenssl-0.11.7.2:=[profile?]
	...
	tar? ( >=dev-haskell/tar-0.6.0.0:=[profile?] <dev-haskell/tar-0.7:=[profile?]
		>=dev-haskell/zip-2.0.0:=[profile?] <dev-haskell/zip-2.1:=[profile?] )
	!tar? ( >=dev-haskell/libarchive-3.0.3.0:=[profile?] <dev-haskell/libarchive-3.1:=[profile?] )
	tui? ( >=dev-haskell/vty-6.0:=[profile?] <dev-haskell/vty-6.3:=[profile?]
		!no-exe? ( >=dev-haskell/brick-2.1:=[profile?] <dev-haskell/brick-2.2:=[profile?] ) )
"
DEPEND="${RDEPEND}
	>=dev-haskell/cabal-3.4.1.0
	test? ( >=dev-haskell/hspec-2.7.10 <dev-haskell/hspec-2.11
