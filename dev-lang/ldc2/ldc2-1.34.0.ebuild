...
IUSE="static-libs hardened"

# We support LLVM 11.0 through 16.0.
...
DLANG_VERSION_RANGE="2.075-2.080 2.082 2.084-"
...
d_src_configure() {
	...
	use hardened && mycmakeargs+=( -DADDITIONAL_DEFAULT_LDC_SWITCHES=' "-relocation-model=pic",' )
	cmake_src_configure
}
